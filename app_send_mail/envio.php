...
try {
	...
	$mail->AltBody = 'É necessário utilizar um cliente que suporte HTML para ter acesso total ao conteúdo do e-mail.';

	$mail->send();

	$mensagem->status['codigo_status'] = 1;
	$mensagem->status['codigo_status'] = 'A mensagem foi enviada.';
} catch (Exception $e) {

	$mensagem->status['codigo_status'] = 2;
	$mensagem->status['codigo_status'] = "Não foi possível enviar este e-mail! Tente novamente mais tarde!";
